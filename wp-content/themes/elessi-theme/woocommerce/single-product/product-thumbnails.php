...
<div class="nasa-thumbnail-default-wrap">
    <div class="product-thumbnails images-popups-gallery nasa-single-product-thumbnails nasa-thumbnail-default">
        ...
        if ($attachment_ids && $product->get_image_id()) :
            ...
            echo sprintf('<div class="nasa-wrap-item-thumb nasa-active" data-main="#nasa-main-image-0" data-key="0" data-thumb_org="%s"><a href="javascript:void(0);" title="%s" class="active-thumbnail">%s</a></div>', $thumb_src, $image_title, $image);
        else :
            $noimage = wc_placeholder_img_src();
            echo sprintf('<div class="nasa-wrap-item-thumb nasa-active" data-main="#nasa-main-image-0" data-key="0" data-thumb_org="%s"><a href="javascript:void(0);" class="active-thumbnail"><img src="%s" /></a></div>', $noimage, $noimage);
        endif;
