...
<div class="nasa-cookie-notice-container">
    <div class="nasa-cookie-notice-centent">
        ...
        <a href="javascript:void(0);" class="nasa-accept-cookie" title="<?php echo esc_attr__('Accept', 'elessi-theme'); ?>" class="button"><?php echo esc_html__('Accept', 'elessi-theme'); ?></a>
    </div>
</div>