                            ...
                            <tr class="nasa-tr-wishlist-item" id="yith-wcwl-row-<?php echo (int) $productId; ?>" data-row-id="<?php echo (int) $productId; ?>">
                                ...
                                <?php if ($is_user_owner) : ?>
                                    <td class="product-remove">
                                        <a href="javascript:void(0);" class="remove nasa-remove_from_wishlist" title="<?php esc_attr_e('Remove this product', 'elessi-theme'); ?>" data-logined="<?php echo (int) NASA_CORE_USER_LOGIGED; ?>" data-prod_id="<?php echo (int) $productId; ?>">
