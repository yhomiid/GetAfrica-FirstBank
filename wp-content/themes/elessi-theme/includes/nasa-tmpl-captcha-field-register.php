...
<script type="text/template" id="tmpl-captcha-field-register">
    <p class="form-row padding-top-10">
        ...
        <a class="nasa-reload-captcha" href="javascript:void(0);" title="<?php echo esc_attr__('Reload', 'elessi-theme'); ?>" data-time="0" data-key="{{key}}"><i class="nasa-icon icon-nasa-refresh"></i></a>
