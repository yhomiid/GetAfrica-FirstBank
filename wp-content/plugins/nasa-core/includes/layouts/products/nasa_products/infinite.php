<?php
$columns_number = (int) $columns_number < 2 || (int) $columns_number > 6 ? 5 : (int) $columns_number;
?>
<div class="nasa-products-infinite-wrap">
    ...
    <div class="nasa-relative text-center desktop-margin-top-40 margin-bottom-20">
        <?php if ($loop->max_num_pages > 1) :
            ...
            ?>
            <a href="javascript:void(0);" class="load-more-btn load-more <?php echo esc_attr($style_viewmore); ?>" data-nodata="<?php esc_attr_e('ALL PRODUCTS LOADED', 'nasa-core'); ?>">
