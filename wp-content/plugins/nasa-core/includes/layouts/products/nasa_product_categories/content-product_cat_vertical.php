<div 
    class="vertical-slider nasa-category-slider-vertical margin-top-20 margin-bottom-20 wow fadeInUp<?php echo $el_class; ?>"
    data-wow-duration="1s"
    data-wow-delay="<?php echo esc_attr($delay_animation_product); ?>ms">
