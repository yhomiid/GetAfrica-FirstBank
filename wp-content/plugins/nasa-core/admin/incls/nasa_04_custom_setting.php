...
function nasa_custom_option_themes() {
    ...
    $of_options[] = array(
        "name" => esc_html__('Show UX Variations in Grid', 'nasa-core'),
    ...
    $of_options[] = array(
        "name" => esc_html__('Enable UX Variations With Type Select, Custom', 'nasa-core'),
    ...
    $of_options[] = array(
        "name" => esc_html__('Load UX Variations in Grid After Click Select Options', 'nasa-core'),
     ...
     */
    $of_options[] = array(
        "name" => esc_html__("Nasa Custom Taxonomies - Group Product", 'nasa-core'),
        "std" => "<h4>" . esc_html__("Nasa Custom Taxonomies - Group Product", 'nasa-core') . "</h4>",
        "type" => "info"
    );
    ...
    $of_options[] = array(
        "name" => esc_html__("Slug Custom Categories", 'nasa-core'),
