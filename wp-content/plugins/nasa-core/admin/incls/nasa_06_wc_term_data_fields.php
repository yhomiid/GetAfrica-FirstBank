    ...
    class Nasa_WC_Term_Data_Fields {
        ...
        public function taxonomy_custom_tax($term = null) {
            ...
            if (is_object($term) && $term) {
                if (!$custom_tax = get_term_meta($term->term_id, $this->_custom_tax)) {
                    $custom_tax = add_term_meta($term->term_id, $this->_custom_tax, '');
                }
                ?>
                ...
                <tr class="form-field nasa-term-root hidden-tag term-custom_tax-wrap">
                    ...
                    <td>             
                        <?php
                        $selected = isset($custom_tax[0]) ? $custom_tax[0] : '';
        ...
        public function taxonomy_cat_sidebar_layout($term = null) {
            ...
            if (is_object($term) && $term) {
                if (!$cat_sidebar = get_term_meta($term->term_id, $this->_cat_sidebar_layout)) {
                    $cat_sidebar = add_term_meta($term->term_id, $this->_cat_sidebar_layout, '');
                }
                ?>
                <!-- Header type -->
                <tr class="form-field nasa-term-root hidden-tag term-cat_sidebar_layout-wrap">
                    ...
                    <td>             
                        <?php
                        $selected = isset($cat_sidebar[0]) ? $cat_sidebar[0] : '';
